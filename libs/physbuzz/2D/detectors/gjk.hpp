...
class Gjk2D : public ICollisionDetector {
  ...
  protected:
    static void Epa(Simplex &simplex, Contact &contact, const Mesh &mesh1, const Mesh &mesh2);
    ...
    static glm::vec3 supportPoint(const Mesh &mesh, const glm::vec3 &direction);
    static glm::vec3 minkowskiSupportPoint(const Mesh &mesh1, const Mesh &mesh2, const glm::vec3 &direction);
