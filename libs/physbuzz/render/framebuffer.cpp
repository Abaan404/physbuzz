...
std::int32_t Framebuffer::activate(Type type, std::size_t colorIndex, std::int32_t unit) const {
...
std::uint32_t Framebuffer::getImGuiTextureHandle(Type type, std::size_t colorIndex) const {
