...
bool RenderPipelineDeferred::Geometry::build() {
    ...
    //                 RenderPipeline::Format::eR8G8B8Snorm,
    //                 RenderPipeline::Format::eR8G8B8Snorm,
...
//     }
//
//     if (!ResourceRegistry<Texture>::contains(ResourceTextureGBuffers[0])) {
//         success &= ResourceRegistry<Texture>::insert(
//             ResourceTextureGBuffers[0],
//             {{
//                 .type = Texture::Type::Attachment,
//                 .sampler = Texture::Sampler::None,
//                 .format = Texture::Format::eR8G8B8Snorm,
//             }},
//             glm::uvec3{1, 1, 1});
//     }
//
//     if (!ResourceRegistry<Texture>::contains(ResourceTextureGBuffers[1])) {
//         success &= ResourceRegistry<Texture>::insert(
//             ResourceTextureGBuffers[1],
//             {{
//                 .type = Texture::Type::Attachment,
//                 .sampler = Texture::Sampler::None,
//                 .format = Texture::Format::eR8G8B8Snorm,
...
//     }
//
//     if (!ResourceRegistry<Texture>::contains(ResourceTextureGBuffers[2])) {
//         success &= ResourceRegistry<Texture>::insert(
//             ResourceTextureGBuffers[2],
//             {{
//                 .type = Texture::Type::Attachment,
//                 .sampler = Texture::Sampler::None,
